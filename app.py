...
# Quinta franja
    ...
    html.Div(children = [dcc.Graph(figure=tabla6)],
             style={'margin': '-60% 0px -50% 55px', 'width':'100%',  #margen: arriba,derecha,abajo,izquierda
...
# Sexta franja
    ...
    html.Div(children = [dcc.Graph(figure=tabla6a)],
             style={'margin': '-2.8% 0px 0% 55px', 'width':'100%',  #margen: arriba,derecha,abajo,izquierda
